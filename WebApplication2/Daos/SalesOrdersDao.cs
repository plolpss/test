...
{
    public class SalesOrdersDao : BaseDao
    {
        /// <summary>
        /// 取得所有的訂單
        /// </summary>
        /// <returns></returns>
        public List<SalesOrders> GetAllOrders()
        {
        ...
        /// <returns></returns>
        public int AddNewOrderReturnNewOrderId(SalesOrders newOrder)
        {
        ...
        public void UpdateOrder(SalesOrders oldOrder)
        {
